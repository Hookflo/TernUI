...
const PLATFORMS: PlatformConfig[] = [
  ...
  },
  {
    ...
    name: "Polar",
    svgName: "polar.svg",
    secretEnv: "POLAR_WEBHOOK_SECRET",
  },
  {
    id: "dodopayments",
    name: "Dodo Payments",
    svgName: "dodo.svg",
    secretEnv: "DODO_WEBHOOK_SECRET",
  },
  {
    id: "gitlab",
    name: "GitLab",
  ...
  },
  {
    id: "replicate",
    name: "Replicate",
    svgName: "replicate.svg",
    secretEnv: "REPLICATE_WEBHOOK_SECRET",
  },
  {
    id: "razorpay",
    name: "Razorpay",
    svgName: "razorpay.svg",
  ...
  },
  {
    ...
    name: "WorkOS",
    svgName: "workos.svg",
    secretEnv: "WORKOS_WEBHOOK_SECRET",
  },
  {
    id: "falai",
    name: "Fal AI",
    svgName: "fal.svg",
    secretEnv: "FAL_WEBHOOK_SECRET",
  },
  {
    id: "lemonsqueezy",
    name: "LemonSqueezy",
    svgName: "lemonsqueezy.svg",
  ...
  },
  {
    ...
    name: "Doppler",
    svgName: "doppler.svg",
    secretEnv: "DOPPLER_WEBHOOK_SECRET",
  },
  {
    id: "sentry",
    name: "Sentry",
  ...
  },
  {
    ...
    name: "Grafana",
    svgName: "grafana.svg",
    secretEnv: "GRAFANA_WEBHOOK_SECRET",
  },
];
...
function SyntaxHighlight({ code }: { code: string }) {
  ...
  while (i < code.length) {
    ...
    if (/[a-zA-Z_$]/.test(code[i])) {
      ...
      if (
        /^[A-Z]/.test(word) ||
        (end < code.length && (code[end] === "(" || code[end] === "."))
      ) {
...
export default function WebhookIntegrationGuide() {
  ...
  const currentPlatform =
    allPlatforms.find((p) => p.id === selectedPlatform) ?? PLATFORMS[0];
  ...
  return (
    <section className="t-webhook-section" id="usage">
      <div className="t-webhook-inner">
        ...
        <div className="t-webhook-header">
          ...
          <h2 className="t-h2">
            Pick a platform,
            <br />
            <em>get your snippet.</em>
          </h2>
          <p className="t-section-desc">
            Real, working code for every supported platform and framework. Copy
            and paste — no adapting needed.
          </p>
        </div>
        ...
        <div className="t-webhook-grid">
          ...
          <div className="t-webhook-sidebar">
            ...
            <div className="t-webhook-platforms">
              {allPlatforms.map((platform) => {
                ...
                const isUserCustom =
                  !!platform.isCustom && platform.id !== "__custom__";
                return (
                  <button
                    key={platform.id}
                  ...
                  >
                    ...
                    <div className="t-webhook-platform-info">
                      <span className="t-webhook-platform-name">
                        {platform.name}
                      </span>
                      {isUserCustom ? (
                        <button
          ...
          <div className="t-code-viewer">
            ...
            <div className="t-code-status">
              <span className="t-status-platform">{currentPlatform.name}</span>
              <span
                style={{
      ...
      {showCustomDialog && (
        <div
          className="t-webhook-dialog-overlay"
          onClick={() => setShowCustomDialog(false)}
        >
          <div
            className="t-webhook-dialog"
      ...
      <style jsx>{`
        ...
        .t-webhook-platform-card.active .t-pl-dot {
          background: #86efac;
        }
        @media (max-width: 860px) {
          .t-webhook-platform-card {
