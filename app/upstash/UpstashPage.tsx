...
const PAGE_CSS = `
  ...
  .up-byok-bot { padding:14px 28px; background:white; display:flex; align-items:flex-start; flex-direction:column; gap:8px; }
  .up-byok-code { font-family:var(--mono); font-size:12px; color:var(--ink2); background:var(--paper2); border:1px solid var(--border); border-radius:4px; padding:8px 14px; word-break:break-all; }
  .up-byok-code span { color:var(--ink4); }
  @media(max-width:640px){ .up-byok-top { padding:16px; } .up-byok-bot { padding:12px 16px; } .up-byok-title { font-size:18px; } }

  /* FLOW */
  .up-flow { display:flex; align-items:center; gap:0; overflow-x:auto; padding-bottom:8px; margin-bottom:48px; -webkit-overflow-scrolling:touch; }
  .up-flow-step { display:flex; flex-direction:column; align-items:center; gap:8px; min-width:80px; flex-shrink:0; }
  ...
  @media(max-width:480px){ .up-features { grid-template-columns:1fr; } }
  ...
  .up-feature-tag { font-family:var(--mono); font-size:10px; background:var(--paper2); border:1px solid var(--border); color:var(--ink2); border-radius:3px; padding:3px 8px; display:inline-block; word-break:break-all; }
  ...
  @media(max-width:600px){
    .up-dlq-row { grid-template-columns:1fr auto; }
    .up-dlq-attempts, .up-dlq-time { display:none; }
  }

  /* DEDUP VISUAL */
  .up-dedup { display:flex; flex-direction:column; gap:8px; }
  .up-dedup-row { display:flex; align-items:center; gap:12px; padding:12px 16px; border-radius:8px; border:1px solid var(--border); background:white; font-family:var(--mono); font-size:12px; flex-wrap:wrap; }
  ...
  .up-dedup-id { color:var(--ink2); flex:1; min-width:0; word-break:break-all; }
  ...
  /* COST TABLE — responsive fix */
  .up-cost-grid { display:grid; gap:24px; grid-template-columns:1fr 1fr; max-width:860px; }
  @media(max-width:700px){ .up-cost-grid { grid-template-columns:1fr; } }
  ...
  @media(max-width:480px){
    .up-cost-table th, .up-cost-table td { padding:10px 12px; font-size:11px; }
  }
  ...
  .up-free-item { font-family:var(--mono); font-size:12px; color:var(--ink2); display:flex; align-items:flex-start; gap:8px; }
  .up-free-check { color:var(--green); font-weight:700; flex-shrink:0; }
  ...
  .up-hero-text { flex: 1; min-width: 0; }
  .up-hero-img {
    flex: 1;
    display: flex;
    align-items: center;
  ...
  @media(max-width:1023px){ .up-hero-img { display: none; } }
  .up-hero-img img { max-width: 100%; height: auto; max-height: 500px; object-fit: contain; }

  /* ── SECTION INNER OVERFLOW ── */
  .t-section-inner { max-width: 100%; overflow-x: hidden; }

  /* ── INSTALL CMD WRAP FIX ── */
  .t-install { overflow-x: auto; }

  /* ── ENV BLOCK WRAP ── */
  .t-env-block { overflow-x: auto; }
`;
    ...
    <div className="tern-root">
        ...
        <div className="up-hero-inner">
          <div className="up-hero-text">
            ...
            <p className="t-hero-desc">
              Every verified webhook is queued, retried on failure,
              deduplicated, and recoverable from a dead-letter queue. Bring Your
              Own Keys (BYOK) — your Upstash account, zero infrastructure. Your
        ...
        <div className="t-section-inner">
          <div className="up-byok">
            <div className="up-byok-top">
              <div>
                <div className="up-byok-title align-middle items-center flex gap-2" style={{ flexWrap: "wrap" }}>
      ...
      >
        <div className="t-section-inner">
          ...
          <div style={{ marginTop: 28 }}>
            ...
            <div className="t-tabs" style={{ overflowX: "auto", flexWrap: "nowrap" }}>
              {[
                "queue: true (Next.js)",
      ...
      >
        <div className="t-section-inner">
          ...
          {/* ── FIXED: responsive grid class instead of inline style ── */}
          <div className="up-cost-grid">
            <div>
